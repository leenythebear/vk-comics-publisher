...
from helper import get_comics_extension, get_comics_filename, save_comic, del_used_comic

from vk_api import get_url_for_upload, upload_comic_to_server, upload_comic_in_album, publish_comic
...
if __name__ == "__main__":
    ...
    upload_server_response = upload_comic_to_server(comic_filename, url_for_upload)
    upload_album_response = upload_comic_in_album(upload_server_response, token)
